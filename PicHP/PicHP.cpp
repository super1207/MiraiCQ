...
extern "C" __int32 __stdcall sendDiscussMsg(__int32 auth_code, __int64 discuss_id, const char *msg);  //未实现
extern "C" __int32 __stdcall deleteMsg(__int32 auth_code, __int64 msg_id);

extern "C" __int32 __stdcall sendLike(__int32 auth_code, __int64 qq);  //未实现
extern "C" __int32 __stdcall sendLikeV2(__int32 auth_code, __int64 qq, __int32 times);  //未实现
...
extern "C" __int32 __stdcall setGroupAnonymousBan(__int32 auth_code, __int64 group_id, const char *anonymous, __int64 duration);  //未实现
...
extern "C" __int32 __stdcall setDiscussLeave(__int32 auth_code, __int64 discuss_id);  //未实现
...
extern "C" __int32 __stdcall getCookies(__int32 auth_code); //未实现
extern "C" __int32 __stdcall getCookiesV2(__int32 auth_code, const char *domain); //未实现
extern "C" __int32 __stdcall getCsrfToken(__int32 auth_code); //未实现
...
extern "C" __int32 __stdcall setRestart(__int32 auth_code);  //未实现
