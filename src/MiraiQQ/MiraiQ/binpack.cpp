...
void BinPack::string_push( const std::string & str )
{
...
void BinPack::int16_push( __int16 num )
{
	content.push_back('\0');
	content.push_back('\0');
...
void BinPack::int64_push( __int64 num )
{
	content.push_back('\0');
	content.push_back('\0');
	content.push_back('\0');
...
void BinPack::bool_push( bool bool_num )
{
...
void BinPack::byte_push( const char * bt,size_t len )
{
...
void BinPack::token_push( const std::vector<char> & token )
{
...
BinPack::BinPack( const std::vector<char> & content )
{
...
void BinPack::int32_push( __int32 num )
{
	content.push_back('\0');
	content.push_back('\0');
	content.push_back('\0');
