...
对于界面简陋的问题，这的确是一个值得吐槽的地方。最开始，我并没有制作界面的打算，现在还可以在代码中看到最开始的控制台版本。我想将MiraiCQ通过wine跑在没有x11 server的linux服务器上，所以，界面是多余的东西。在代码里，界面和功能是分离的，重构界面并不是难事，但是，目前打算咕着。<br />
